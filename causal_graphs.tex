...
\begin{figure} 
    ...
    \addtocounter{figure}{-1}
    \begin{subfigure}{\textwidth}
        \caption{Causal diagram for \citet{Kelly:2012ih}} \label{fig:kl}
        \centering
		\begin{tikzpicture}
    ...
    \begin{subfigure}[b]{\textwidth}
        \caption{Causal diagram for \citet{Balakrishnan:2014js}} \label{fig:bbkl}
        \centering
		\begin{tikzpicture}
						\node[rectangle] (BC) {Brokerage closure$_t$}; 
			\node [right = 1 of BC] (AC0) {Analyst coverage$_t$};
    ...
    \end{subfigure}
        ...
        \begin{subfigure}[b]{\textwidth}
        \caption{Alternative causal diagram for \citet{Balakrishnan:2014js}} \label{fig:bbkl_alt}
        \centering
		\begin{tikzpicture}
						\node[rectangle] (BC) {Brokerage closure$_t$}; 
			\node [right = 1 of BC] (AC0) {Analyst coverage$_t$};

...
Some of the discussion \citet{Kirk:2014gx} suggests that they are interested in the differential effect of Reg FD on firms with and without IR departments.
It is perhaps helpful to follow the advice of \citep[p.\,236]{Cochran:1965if}, who write: ``The planner of an observational study should always ask himself the question, `How would the study be conducted if it were possible to do it by controlled experimentation?'"
In this case, \citet{Kirk:2014gx} would like to run an experiment where Reg FD was assigned to firms randomly and compare the effects of Reg FD	

...
Because the timing of his events (e.g., fires and natural disasters) relative to balance sheet date is plausibly random, the assignment to the disclosure and recognition is also plausibly random. 
...
Unfortunately, there are few (if any) accounting variables that meet the strong test that there are exogenous and not variables that directly impact the outcome of interest.
...
But such tests of instruments may are of dubious value. 
...
If true, we would expect to see an estimate of approximately zero effect, even if there were substantial benefits of the law for shareholders of firms well above the threshold.
...
%NOTE: 13.7 Permissible changes to punctuation, capitalization, and spelling

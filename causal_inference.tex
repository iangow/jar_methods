...
\begin{abstract}\normalsize
	This paper examines approaches accounting researchers use to draw causal inferences from observational (or non-experimental) data. 
	The vast majority of research papers draw causal inferences, notwithstanding the well-known difficulties with doing so.
	While some papers use quasi-experimental research designs to estimate causal effects, it is rarely the case that the data and
...
In Section \ref{sec:causal}, we examine the use of these traditional methods and the appropriateness of their use for causal inference.
...
\item Increased use of structural models.
	...
	A more sound basis for hypothesis development could be one drawing on detailed descriptive evidence of interesting phenomena.

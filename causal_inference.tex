...
Other fields also seek to draw causal inferences and need to grapple with the problematic features of observational data. 
...
We suspect that the value of the study of mechanisms is perhaps underestimated, perhaps due to a belief that the path to credible causal inferences involves clever identification strategies.
However, even with such a strategy, we believe that causal mechanisms have an important role.

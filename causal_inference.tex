...
\begin{abstract}\normalsize
	...
	While some papers seek to use quasi-experimental methods to claim unbiased estimates of causal effects, we find that the application of these methods in accounting research does generally provide the basis for drawing causal inferences.
	...
	We believe that these shifts in approach provide a viable and practical path forward for accounting research.
\end{abstract}

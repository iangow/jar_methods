...
\begin{titlepage}
  \centering
  	\begin{large}
  	\textbf{Causal Inference in Accounting Research\footnote{We are grateful to our discussants and participants at the 2015 JAR Conference for helpful feedback. We also thank seminar participants at London Business School, Karthik Balakrishnan, Philip Berger, Robert Kaplan, Alexander Ljungqvist, Eugene Soltes, Daniel Taylor, Robert Verrecchia, Charles Wang, and Anastasia Zakolyukina for comments.}} \\	
  	\end{large}
  	\vspace{60pt}
	\textbf{Ian D. Gow} \\
...
\begin{abstract}
	...
	While recent papers seek to use quasi-experimental methods to improve causal 
	inferences, these methods also make strong assumptions that are not always fully
	appreciated. We believe that accounting research would benefit from: 
...
%TODO: Add a bit more of a road map here.

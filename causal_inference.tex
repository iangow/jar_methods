...
\citet{Balakrishnan:2014js} treat closure of brokerage firms as an exogenous (i.e., ``as if" random) source of variation in analyst coverage.\footnote{
\citet{Kelly:2012ih} was the first paper to identify these brokerage closures as a plausible source of ``as if" random) source of variation in analyst coverage.
\citet{Kelly:2012ih} which they argue will affect liquidity only through the its effect on information asymmetry

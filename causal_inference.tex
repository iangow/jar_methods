...
These is typically very little or no theoretical justification for the validity of variables that are selected as instruments.  It is generally difficult to believe that variables such as firm size, leverage, corporate governance, or director age are viable instrumental variables for typical studies.  Similarly, there are serious concerns about using lagged values of endogenous variables or industry averages of endogenous variables as instruments.\footnote{See \citet{Reiss:2007ej} for a discussion regarding the inability to claim that industry averages are valid instruments.}
...
We find very few cases of an instrumental variable analysis in our survey of accounting research that can withstand rigorous scrutiny.
...
While IV is a classic textbook approach for drawing credible causal inferences, its applicability in actual research settings seems very limited.  Although a plausible methodological approach, the inability to theoretically justify valid instruments seriously limits the applicability of instrumental variable methods in observational accounting research. 

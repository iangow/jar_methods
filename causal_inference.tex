...
One paper with a credible natural experiment is that studied by \citet{Michels:2015}.
\citet{Michels:2015} exploits the difference in disclosure requirements for significant events that occur before financial statements are issued that differ according to whether the event occurs before or after the balance sheet date.
...
As recognized by \citet{Michels:2015}, there are possibly different materiality criteria that affect the relation been underlying events and the disclosures the he relies on.
...
Certainly researchers should exploit these natural experiments when they occur \citep[as in][]{Michels:2015}, but that care is needed in doing so and that researchers should not to stretch the concept to situations where it does not apply.

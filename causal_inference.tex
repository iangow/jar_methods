...
The goal of this paper is to evaluate the approaches used by accounting researchers to causal inference using observational (or non-experimental) data and, drawing on developments in fields such statistics, epidemiology, sociology, and political science, identify opportunities for improvement.
...
However, with observational data, treatment assignment is outside the control of the researcher and quite likely driven by forces that confound attempts to estimate causal effects using approaches that would appropriate using experimental data.
...
Ultimately we believe that accounting researchers need to shift their focus from the ``false promises" of causal inference using quasi-experimental methods.

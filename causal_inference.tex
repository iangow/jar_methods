...
Most papers examine ``exogenous shocks" that do not sort firms into treatment and control groups.
Other papers use assignment to treatment and control that is not random (e.g., Reg FD or adoption of IFRS).
...
But extending our survey beyond research published in 2014, we find some papers with credible natural experiments.

...
\section{Causal inference in accounting research: Current practice}
...
Of the  103 original, archival papers, we coded 90 as seeking to draw causal inferences. Of the remaining empirical papers, we coded 5 papers as having a goal of ``description.'' 
...
In coding 90 archival papers as seeking to draw causal inferences, we generally examined the title and abstract for evidence of causal inference. 
...
\subsection{Endogeneity and Pearl's Structural Causal Model}
...
\subsection{The Structural Causal Model}

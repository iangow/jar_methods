...
In other cases, the assumption that the causal relation between variables included as ``controls" is best represented by Figure \ref{fig:confound} rather than either of Figures \ref{fig:mech} or \ref{fig:collider}.
...
But the essential feature of instrumental variables and regression discontinuity methods is the as-if random treatment assignment mechanism that these methods potentially provide for the research design.

...
The challenge faced by \citet{Kelly:2012ih} is that changes in analyst coverage are generally not random. 
To identify as-if random changes, \citet{Kelly:2012ih} use changes in coverage following mergers of brokerage firms that covered
...
Recently, RD designs have attracted the interest of accounting researchers, as a number of phenomena of interest to accounting researchers involve discontinuities. For example, whether an executive compensation plan is approved is a discontinuous function of shareholder support \citet{Armstrong:2013io}.

While RD designs make relatively mild assumptions about the distribution of the running variable, in practice these assumptions may be violated.

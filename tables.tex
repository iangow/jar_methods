...
{\bf CEOPAY} is the CEO's annual base salary.  
{\bf CEOBONUS} is the fraction of a CEO's total pay that is incentive compensation.  
...
{\bf INTERNAT} is a zero-one indicator for non-US corporation.  
{\bf SEGMENTS} is number of the firm's business segments.
...
\begin{table}[t]
\caption{Logit GMM Estimates for the Strategic Auditor Model} \label{tab:logit}
\begin{center}
\begin{tabular}{|c|cc|}
\hline

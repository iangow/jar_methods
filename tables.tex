...
{\bf OPTIONS} is the fraction of a CEO's total pay that is stock-based compensation.  
...
{\bf RESTATE}, a zero-one indicator for whether the firm made a restatement in a particular year, on a proxy for managerial incentives ({\bf OPTIONS}) and controls.
{\bf SALARY} is the CEO's annual base salary.  
{\bf OPTIONS} is the fraction of a CEO's total pay that is stock-based compensation.  
{\bf BIG4} is a zero-one indicator for whether the firm uses a Big 4 auditor.
{\bf FINDIRECT} is the fraction of the board of directors with a finance background. 
...
\T {\bf Intercept} &   -2.210*   &   & -2.786*   &    \\
 ...
 {\bf OPTIONS}  &   -0.644*   &  -0.055* & -0.673*   &  -0.056*  \\

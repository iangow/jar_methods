...
Sections \ref{sec:causal} and \ref{sec:quasi} suggested that minimally researchers should use diagrammatic models to communicate the basis for the their causal inferences.

...
%TODO: Get rid of empty space here.
\begin{enumerate}
...
The EQUITY variable is intended to capture the idea that the more a CEO is rewarded for performance, the
...
\mbox{Pr(Restate)} = \theta_0 \mbox{Pr}\left(\, \theta_1 + \theta_2 \mbox{EQUITY}

...
For example, \citet{Hollander:2010jg} suggests that ``one camp [of analytical research] argues that firms with good information quality will issue less expansive disclosures because information asymmetry is lower in such firms \citep[e.g.][]{Verrecchia:1983}," notwithstanding the absence of any result in \citet{Verrecchia:1983} to support this claim.
...
Of course, these links can be added to the structural model and we can conduct formal goodness-of-fit tests and evaluate out-of-sample predictive validity of the expanded model to assess consistency with the observed data.
